const analyticsContainer = document.getElementById('bars')
const populationButton = document.getElementById('button1')
const languagesButton = document.getElementById('button2')
